...
namespace Contacts {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int contact_Id, string name, string phone_number, string email, string address, string fav_food, System.DateTime birthday, System.DateTime last_call, string alt_phone, string company_name) {
...
namespace Contacts.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([contact Id], [name], [phone number], [email], [address], [fav food], [birthday], [last call], [alt phone], [company name]) VALUES (@contact_Id, @name, @phone_number, @email, @address, @fav_food, @birthday, @last_call, @alt_phone, @company_name);
SELECT [contact Id], name, [phone number], email, address, [fav food], birthday, [last call], [alt phone], [company name] FROM [Table] WHERE ([contact Id] = @contact_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [contact Id] = @contact_Id, [name] = @name, [phone number] = @phone_number, [email] = @email, [address] = @address, [fav food] = @fav_food, [birthday] = @birthday, [last call] = @last_call, [alt phone] = @alt_phone, [company name] = @company_name WHERE (([contact Id] = @Original_contact_Id) AND ([phone number] = @Original_phone_number) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_birthday = 1 AND [birthday] IS NULL) OR ([birthday] = @Original_birthday)) AND ((@IsNull_last_call = 1 AND [last call] IS NULL) OR ([last call] = @Original_last_call)) AND ((@IsNull_alt_phone = 1 AND [alt phone] IS NULL) OR ([alt phone] = @Original_alt_phone)));
SELECT [contact Id], name, [phone number], email, address, [fav food], birthday, [last call], [alt phone], [company name] FROM [Table] WHERE ([contact Id] = @contact_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [contact Id], name, [phone number], email, address, [fav food], birthday, " +
                "[last call], [alt phone], [company name] FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_contact_Id, string Original_phone_number, string Original_email, global::System.Nullable<global::System.DateTime> Original_birthday, global::System.Nullable<global::System.DateTime> Original_last_call, string Original_alt_phone) {
        ...
        public virtual int Insert(int contact_Id, string name, string phone_number, string email, string address, string fav_food, global::System.Nullable<global::System.DateTime> birthday, global::System.Nullable<global::System.DateTime> last_call, string alt_phone, string company_name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string phone_number, string email, string address, string fav_food, global::System.Nullable<global::System.DateTime> birthday, global::System.Nullable<global::System.DateTime> last_call, string alt_phone, string company_name, int Original_contact_Id, string Original_phone_number, string Original_email, global::System.Nullable<global::System.DateTime> Original_birthday, global::System.Nullable<global::System.DateTime> Original_last_call, string Original_alt_phone) {
            return this.Update(Original_contact_Id, name, phone_number, email, address, fav_food, birthday, last_call, alt_phone, company_name, Original_contact_Id, Original_phone_number, Original_email, Original_birthday, Original_last_call, Original_alt_phone);
        }
    }
